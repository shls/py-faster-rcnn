...
class sdha(imdb):
    ...
    def image_path_from_index(self, index):
        ...
        for ext in self._image_ext:
            image_path = os.path.join(self._data_path, 'Images', 'mix', 'spatial-mhi2', self._image_set,
                                  index + ext)
    ...
    def _load_sdha_annotation(self, index):
        ...
        """
        filename = os.path.join(self._data_path, 'Annotations', self._image_set, index + '.txt')
        # print 'Loading: {}'.format(filename)
