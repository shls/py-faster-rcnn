...
net = caffe.Net('/home/ls/py-faster-rcnn/net_surgery/mhi/original.prototxt','/home/ls/py-faster-rcnn/data/imagenet_models/VGG_CNN_M_1024.v2.caffemodel', caffe.TRAIN)
params_m = ['conv1']
...
# Load New net
new_net = caffe.Net('/home/ls/py-faster-rcnn/net_surgery/mhi/mhi.prototxt', caffe.TRAIN)
new_params_m = ['conv1']
...
for pr, new_pr in zip(params_m, new_params_m):
	for n in range (0, fc_params_m[pr][0].shape[0]):
		...
		new_fc_params_m[new_pr][0][n][0] = new_fc_params_m[pr][0][n][0]/fc_params_m[pr][0].shape[0]
...
new_net.save('/home/ls/py-faster-rcnn/net_surgery/mhi/VGG_CNN_M_1024.v2.sdha.b.caffemodel')
